...
## Decision Gate
Before doing any work on this story, check: does Go's Oracle/NetSuite work calendar appear inside his Google Calendar (as a subscribed calendar or auto-synced events)?
...
Syncs Go's Outlook/Microsoft 365 work calendar into the Notion Family Calendar using the same schema and pattern established by Story 04. Adds Source: Outlook and Person: Go.
